...
@onready var master: VBoxContainer = $Master
...
func set_sliders() :
	...
	master.set_value(Globals.audio.master_volume)
	music.set_value(Globals.audio.music_volume)
	sfx.set_value(Globals.audio.sfx_volume)
